...
urlpatterns = [
    ...
    url(r'^testcharters/$', show_test_charters, name='show_all_test_charters'),
    url(r'^testcharters/version/([0-9]+)/$', show_test_charters, name='show_all_test_charters'),
    ...
    url(r'^testgroups/$', show_test_groups, name='show_all_test_groups'),
    url(r'^testgroups/version/([0-9]+)/$', show_test_groups, name='show_all_test_groups'),
    ...
    url(r'^testgroup/([0-9]+)/run/([0-9]+)/$', run_test_case, name='run_test_case_by_id_from_group'),
