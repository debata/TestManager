...
urlpatterns = [
    ...
    url(r'^testgroup/version/([0-9]+)/$', show_test_groups, name='show_all_test_groups_by_id'),
    ...
    url(r'^testresult/comment/([0-9]+)/$', add_comment_test_result, name='add_comment_test_result'),
    url(r'^testsession/([0-9]+)/$', view_test_session, name='view_test_session'),
    url(r'^test_session/comment/([0-9]+)/$', add_comment_test_session, name='add_comment_test_session'),
    url(r'^defect/$', show_defects, name='show_all_defects'),
    url(r'^defect/comment/([0-9]+)/$', add_comment_defect, name='add_comment_defect'),
